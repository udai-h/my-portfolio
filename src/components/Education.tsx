export default function Education() {
  return (
    <section id="education" className="max-w-3xl mx-auto px-6 pt-16 text-left">
      <h2 className="lg:text-2xl text-xl font-bold mb-4">Education</h2>
      <div className="space-y-10">
        <div className="lg:flex lg:gap-6">
          <div className="lg:w-1/4 mb-2 lg:mb-0">
            <p className="lg:text-sm text-xs text-navy dark:text-beige mt-1">
              Jan 2023 - Dec 2025 (Expected)
            </p>
          </div>
          <div className="lg:w-3/4 space-y-1">
            <h3 className="lg:text-xl text-lg font-semibold text-navy dark:text-beige">
              Bachelor of Science in Computer Science
            </h3>
            <p className="lg:text-base text-base font-bold italic text-navy dark:text-beige">
